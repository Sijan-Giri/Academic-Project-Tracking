...
router.post('/', authenticate, requireRoles('PANEL', 'COORDINATOR', 'ADMIN'), evaluationController.submitEvaluation);
router.get('/:id', authenticate, evaluationController.getEvaluationById);
router.put('/:id', authenticate, requireRoles('PANEL', 'COORDINATOR', 'ADMIN'), evaluationController.updateEvaluation);
